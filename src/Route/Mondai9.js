...
export default class Mondai9 extends Component {
    ...
    handleAnswerChange = async (num) => {
        ...
        await window.sessionStorage.setItem('mon9', this.state.selected)
    }
    ...
    render() {
        return (
            <div className="out">
                ...
                <Alert.Heading>問題9</Alert.Heading>
                <p className="mb-0">道を聞く時、どう言えばいいですか？</p>
                </Alert>
                <span className="monlongans">1. 당신의 이름은 무엇입니까?</span><br/>
                <span className="monlongans">2. 여기는 어떻게 가야하나요?</span><br/>
                <span className="monlongans">3. 당신, 돈 많습니까?</span><br/><br/>
